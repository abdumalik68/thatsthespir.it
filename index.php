...
$metatags = array(
    ...
    'image'=>WWWROOT.'/ui/img/tts-og-cover-image.jpg',
    'image:width'=>800,
    'image:height'=>574,
    'url' => WWWROOT);
...
$f3->route('GET @api: /api', function ($f3) {
    require 'controllers/api.get.php';
});

$f3->route('GET @random: /random/@format', function ($f3) {
    require 'controllers/random.get.php';
});
$f3->route('GET @random: /random', function ($f3) {
    require 'controllers/random.get.php';
});

$f3->route('GET @latest: /latest', function ($f3) {
    require 'controllers/latest.get.php';
});
$f3->route('GET @popular: /popular', function ($f3) {
    require 'controllers/popular.get.php';
});

$f3->route('GET @user_favourites: /of-mine', function ($f3) {
    require 'controllers/user-favourites.get.php';
});

$f3->route('GET @archive: /human-channels', function ($f3) {
    require 'controllers/human-channels.get.php';
});

$f3->route('GET @feed: /feed', function ($f3) {
    require 'controllers/feed.get.php';
});
$f3->route('GET @feed: /feed/@format', function ($f3) {
    require 'controllers/feed.get.php';
});

$f3->route('GET @feed_random: /feed_random', function ($f3) {
    require 'controllers/feed_random.get.php';
});

$f3->route('GET @sitemap: /sitemap', function ($f3) {
    require 'controllers/sitemap.get.php';
});
$f3->redirect('GET|HEAD /sitemap.xml', '/sitemap');

$f3->route('POST @favourite: /favourite/@quote [ajax]', function ($f3) {
    require 'controllers/favourite.ajax.php';
});


$f3->route('GET @search: /search [ajax]', function ($f3) {
    require 'controllers/search.ajax.php';
});

$f3->route('GET|POST @author_edit: /author/@action/@slug', function ($f3) {
    require 'controllers/author-edit.get.post.php';
});

$f3->route('GET|POST @author_add: /author/add', function ($f3) {
    require 'controllers/author-add.get.post.php';
});

$f3->route('GET|POST @quote_add: /quote/add', function ($f3) {
    require 'controllers/quote-add.get.post.php';
});

$f3->route('GET|POST @quote_action: /quote/@action/@id', function ($f3) {
    require 'controllers/quote-action.get.post.php';
});

$f3->route('GET @pending_quotes: /pending', function ($f3) {
    require 'controllers/pending-quotes.get.php';
});

$f3->route('GET /of/@author', function ($f3) {
    require 'controllers/author-single.get.php';
});

$f3->route('GET @auth: /auth', function ($f3) {
    require 'vendor/hybridauth/hybridauth/hybridauth/index.php';
});

$f3->route('GET @auth_action: /auth/@action', function ($f3) {
    require 'controllers/auth-action.get.php';
});

$f3->route('GET @login: /login', function ($f3) {
    require 'controllers/login.get.php';
});
...
$f3->route('GET @fix_totals: /fix-author-totals', function ($f3) {
    require 'controllers/fix-author-totals.get.php';
});

$f3->route('GET @privacy_policy: /privacy-policy', function ($f3) {
    require 'controllers/privacy-policy.get.php';
});

$f3->route('GET @mailinglist: /daily', function ($f3) {
    require 'controllers/daily.get.php';
});
$f3->route('GET @thankyou: /thank-you-dear', function ($f3) {
    require 'controllers/thank-you.get.php';
});
