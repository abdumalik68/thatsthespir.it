...
?></h1>
		<figure class="author">
			...
			<figcaption><?= $author['fullname'] ?> <br><small class="meta contribution"><?= $author['total'] ?> quote<?php echo ((int)$author['total']>1) ? 's':''; ?></small><?php if ($user['role']==='admin'){ ?>
			<p class="quote-meta"><a href="/author/delete/<?php echo $author['slug'] ?>">[ X ] kill author</a></p><?php }?></figcaption>
